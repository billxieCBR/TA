		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#IncidentReport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IncidentReport-display": {
								"semanticObject": "IncidentReport",
								"action": "display",
								"description": "My Incident Report",
								"title": "Incident Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=incidentsp039131ui",
									"url": sap.ui.require.toUrl("incidentsp039131ui")
								}
							}
						}
					}
